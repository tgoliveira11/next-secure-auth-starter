...
/**
 * CONSUMER-DEMO CUSTOMIZATION — NOT part of @tgoliveira/secure-auth.
 * Admin navigation bar. Uses useUiPaths() from the package for consistent path resolution.
 */
...
export function AdminNav() {
  ...
  return (
    <header className="sticky top-0 z-10 border-b border-[var(--border)] bg-[var(--card)]">
      <div className="mx-auto flex max-w-6xl items-center gap-4 px-6 py-0">
        <Link href={base} className="flex shrink-0 items-center gap-2 py-3 text-sm font-semibold text-[var(--foreground)]">
