...
import { getCheckEmailMessage } from "@tgoliveira/secure-auth/client";
import { accountAuthApi } from "@tgoliveira/secure-auth/client";

function CheckEmailContent() {
  const searchParams = useSearchParams();
  const email = searchParams.get("email") ?? "";
  const checkEmailMessage = getCheckEmailMessage(searchParams.get("required") === "1");
  ...
  return (
    <PageLayout width="narrow">
      <PageHeader title="Check your email" description={checkEmailMessage} />
