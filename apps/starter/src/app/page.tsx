...
import { DocumentationLinksSection } from "@/components/marketing/documentation-links-section";
...
export default function HomePage() {
  return (
    <PageLayout width="wide" className="max-w-5xl">
      <div className="space-y-12 py-8 md:space-y-16 md:py-16">
