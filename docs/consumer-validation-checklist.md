...
Use this when integrating `@tgoliveira/secure-auth@0.1.9-internal` into a **new** consumer application.
...
- [ ] `@tgoliveira/secure-auth@0.1.9-internal` installed from registry
...
- [ ] Health route returns `version: "0.1.9-internal"`
...
| --- | --- |
| Consumer app name | |
| Package version | `0.1.9-internal` |
| Validated by | |
| Date | |
