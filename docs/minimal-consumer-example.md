...
Smallest working integration of `@tgoliveira/secure-auth@0.1.5-internal` in a new Next.js App Router app.
...
# {"ok":true,"package":"@tgoliveira/secure-auth","version":"0.1.5-internal"}
```
