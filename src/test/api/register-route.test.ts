...
describe("register API route", () => {
  ...
  it("skips verification email when disabled by account policy", async () => {
    const original = process.env.EMAIL_VERIFICATION_SEND_ON_REGISTER;
    process.env.EMAIL_VERIFICATION_SEND_ON_REGISTER = "false";
    ...
    if (original === undefined) {
      ...
      process.env.EMAIL_VERIFICATION_SEND_ON_REGISTER = original;
    }
  });
