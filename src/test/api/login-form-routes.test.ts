...
import { POST as startFormPost } from "@/app/api/auth/login/start-form/route";
import { POST as verify2faFormPost } from "@/app/api/auth/login/verify-2fa-form/route";
import { POST as completePost } from "@/app/api/auth/login/complete/route";
import {
