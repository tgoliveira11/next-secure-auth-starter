...
export function createAccountSessionRepository(db: DbClient) {
  const repo = {
    async create(
      data: {
        userId: string;
...
export type AccountSessionRepository = ReturnType<typeof createAccountSessionRepository>;
